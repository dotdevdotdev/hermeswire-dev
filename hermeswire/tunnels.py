"""
SSH tunnel management for HermesWire.
...
from .utils.paths import hermeswire_dir
    ...
    def __init__(self, state_dir: Optional[Path] = None):
        ...
        Args:
            state_dir: Directory to store tunnel state (PIDs, etc.)
                      Defaults to ~/.hermeswire/tunnels/
        """
        self.state_dir = state_dir or (hermeswire_dir() / "tunnels")
