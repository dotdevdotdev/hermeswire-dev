...
HermesWire wheel must not hard-depend on a specific Hermes version). When that
import is unavailable — e.g. the HermesWire interpreter is not the one Hermes is
