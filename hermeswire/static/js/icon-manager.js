...
export class IconManager {
    ...
    constructor(type) {
        this.type = type;
        this.storageKey = `hermeswire_icons_${type}`;
     ...
     * @returns {string|null} Matching icon path (e.g., 'custom/hermeswire.png') or null
     */
    _findNameMatch(itemName) {
        // Strip @machine suffix for remote sessions (e.g., "hermeswire-tts@dotdev-pc" → "hermeswire-tts")
